                                    ...
                                    <div class="card__inner">
                                        <a style="display:block" href="<?php the_permalink(); ?>" class="card__image-wrapper">
                                            ...
                                            <div class="card__image card__image--primary card__image--active">
                                                <div class="rimage-outer-wrapper">
                                                    <div class="rimage-wrapper">
                                                        <img class="rimage__image fade-in cover lazyautosizes lazyloaded" alt="<?php the_title() ?> - AMINU" loading="lazy" src="<?php the_post_thumbnail_url('medium') ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card__image card__image--reveal">
                                                ...
                                                <div class="rimage-outer-wrapper">
                                                    <div class="rimage-wrapper">
                                                        <img class="rimage__image fade-in lazyautosizes lazyloaded" alt="<?php the_title() ?> - AMINU" loading="lazy" src="<?php echo wp_get_attachment_image_url($gallery_image_ids[0], 'medium') ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
